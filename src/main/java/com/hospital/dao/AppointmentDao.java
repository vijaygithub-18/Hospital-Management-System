...
public class AppointmentDao {
	...
	// Method to get all appointments for a user based on their user ID.
	...
	// Method to get all appointments for a doctor based on their doctor ID.
	...
	// Method to update the status of an appointment by its ID and the doctor's ID.
